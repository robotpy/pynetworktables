...
def test_EntryNewLocal(nt_live, server_cb):
    ...
    nt_server_api.addEntryListenerById(nt_server_api.getEntryId("/foo"),
                                       server_cb, NT_NOTIFY_NEW | NT_NOTIFY_LOCAL)
    
    # Trigger an event
    nt_server_api.setEntryValueById(nt_server_api.getEntryId("/foo/bar"),
                                Value.makeDouble(2.0))
    nt_server_api.setEntryValueById(nt_server_api.getEntryId("/foo"),
...
def test_PrefixNewRemote(nt_live, server_cb):
    ...
    nt_client_api.setEntryValueById(nt_client_api.getEntryId("/foo/bar"),
                                Value.makeDouble(1.0))
    nt_client_api.setEntryValueById(nt_client_api.getEntryId("/baz"),
                                Value.makeDouble(1.0))
